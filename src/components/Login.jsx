  ...
  return (
    <form>
      <div className="p-4 flex flex-col items-center h-screen">
        <h1 className="text-xl font-bold my-4">Panel administrador</h1>
        <div className="bg-flora-base rounded-xl px-5 py-3 shadow-2xl w-72">
          ...
          <input
            type="email"
            id={id}
            className="rounded-md shadow-md border-[1px] outline-flora-base border-neutral-500/5 p-2 my-4"
          />
          <label htmlFor={id} className="block text-md font-bold text-flora-white">
            Contraseña
          </label>
