    ...
    <div className="h-[65vh] w-screen grid place-content-center place-self-center">
      ...
      >
        ...
        <input
          ...
          id={id}
          accept="image/*"
          className="w-full rounded-md my-3 bg-flora-white cursor-pointer file:cursor-pointer file:transition-colors file:duration-300 file:bg-flora-base file:hover:bg-flora-hover file:border-none file:w-36 file:w-full file:p-4"
        />
        <button
          type="submit"
